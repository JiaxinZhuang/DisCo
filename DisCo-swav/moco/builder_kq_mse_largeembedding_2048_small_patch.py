...
class MoCo(nn.Module):
    ...
    def forward(self, im_q, im_k, small_img):
        """
        Input:
        ...
        # Small patch: computer query features
        q_small = self.encoder_q(small_img)
        ...
        with torch.no_grad():  # no gradient to keys
            ...
            teacher_q_small = self.teacher_encoder_q(small_img)
            teacher_q_small = nn.functional.normalize(teacher_q_small, dim=-1)
        ...
        return logits, labels, q, teacher_q, qk, teacher_qk, teacher_q_small, q_small
